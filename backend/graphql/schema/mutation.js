...
const RootMutation = new GraphQLObjectType({
  ...
  fields: {
    ...
    addKnowledge: {
      type: KnowledgeType,
      args: {
        klbavatar: { type: new GraphQLNonNull(GraphQLString) },
        faqavatar: { type: new GraphQLNonNull(GraphQLString) },
        sfavatar: { type: new GraphQLNonNull(GraphQLString) },
        maintitle: { type: GraphQLString },
        faq: { type: new GraphQLNonNull(GraphQLString) },
        klb: { type: new GraphQLNonNull(GraphQLString) },
        sf: { type: new GraphQLNonNull(GraphQLString) },
